...
class FourBranchSerialSystemReliabilityBenchmarkProblem(
    ...
    def __init__(self):
        """
        Create the four-branch serial system from Waarts.
        ...
        Sampling. Ph. D. thesis, Technical University of Delft,
        The Netherlands.
        Pages 58, 69, 160.
        ...
        super(FourBranchSerialSystemReliabilityBenchmarkProblem,
